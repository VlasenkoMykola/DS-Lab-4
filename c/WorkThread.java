    ...
    public void changePrice() {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Changing the price from " + i + " to " + j + " is " + priceToChange);
            } catch (Exception e) {e.printStackTrace();}
            System.out.println("Finished changing the price");
            ...
            try {
                if (addBool) {
                    ...
                    try {
                        ...
                        System.out.println("Changing the price: Added from " + i + " to " + j + " is " + new_price);
                    } catch (Exception e) {e.printStackTrace();}
                } else {
                    try {
                        matrix.setInteger(i, j, -1);
                        System.out.println("Changing the price: Deleted from " + i + " to " + j);
                    } catch (Exception e) {e.printStackTrace();}
                }
                matrix.setInteger(i, j, -1);
            } catch (Exception e) {e.printStackTrace();}
